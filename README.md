I have used the code to obtain all the results for my thesis and a future paper. The code creates the Hamiltonian for either a 1D or quasi-1D tight binding model. 
optional functions:
